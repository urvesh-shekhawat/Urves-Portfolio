...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const commands = [
    ...
    { title: 'Contact / Connect', category: 'Navigation', shortcut: 'G C', action: () => scrollToSection('#contact') },
    { title: 'View VulnEye Security Platform', category: 'Projects', shortcut: 'P V', action: () => window.openProjectModal('vulneye') },
    { title: 'View AeroSky Weather PWA', category: 'Projects', shortcut: 'P A', action: () => window.openProjectModal('aerosky') },
